...
r.rect(0, 0, rectSize, rectSize).fill(40);

// draw a rectangle in the right corner
r.rect(r.width - rectSize, 0, rectSize, rectSize).fill(40);

// draw a rectangle in the center
r.rect(r.width / 2 - rectSize / 2, 0, rectSize, rectSize).fill(40);

// draw a rectangle at the golden ratio x
var golden = (1 + Math.sqrt(5)) / 2;
r.rect(r.width / golden, 0, rectSize, rectSize).fill(40);

// draw an ellipse in the center of screen
r.circle(r.width / 2, r.height / 2, circleRadius).fill(0, 0, 255);
...
r.circle((r.width / 2) + x, (r.height/2) + y, 10).fill(255, 0, 0);

...
void setup() 
{
  ...
  // now we create a style for that path. You can read more here:
  // http://www.ricardmarxer.com/geomerative/documentation/geomerative/RStyle.html
  RStyle mainStyle = new RStyle();
  mainStyle.setFill(color(255, 0, 0));
  mainStyle.setStroke(30);
  house.paths[2].setStyle(mainStyle);
